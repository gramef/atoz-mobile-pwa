...
<thead>
    <th style="font-size: 28px; font-weight: bold; padding-bottom: 20px;">
        Job <span style="text-transform: capitalize;">Rejected</span>
    </th>
</thead>
<tbody>
    <tr>
    ...
    <tr>
        <td>
          <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
            Hi Admin, the agent for the job <span style="font-weight: bold">{{ $job->reference }}</span> rejected the client's changes.
          </p>
            <div>
                <!--[if mso]>
