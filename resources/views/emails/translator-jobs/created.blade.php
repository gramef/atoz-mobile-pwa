...
@section('content')
    ...
    <tbody>
        <tr>
            <td>
              ...
              @if ($wasSentToAdmin)
                <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                    Hi Admin, a new job request has been posted within the portal, please see summary below. Login into the portal to see full details.
                </p>
              @else
                  <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
            ...
            @include('emails.translator-jobs.table')
