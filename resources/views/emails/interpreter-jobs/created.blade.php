        ...
        <td>
            ...
            @if ($wasSentToAdmin)
                <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                    Hi Admin, a new job request has been posted within the portal, please see summary below. Login into the
            ...
            @else
                ...
                <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                    Once your job has been approved and assigned you will receive an email notification.
                </p>
            @endif

            @include('emails.interpreter-jobs.table')
            ...
            @if (!$wasSentToAdmin && $job->canBeCancelled())
                <p style="font-size: 12px;line-height: 18px;font-style:italic;font-weight: 500;padding-top: 41px">
                    PLEASE NOTE: <br>
                    If you need to cancel your booking, please do so by contacting a member of the A to Z team or by clicking cancel
                    against the relevant job within the portal. Please note cancellation charges may apply. Please refer to our terms
                    and
                    conditions.
                </p>
            @endif
