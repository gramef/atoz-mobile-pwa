    ...
    <tr>
        <td>
            <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                This is an email notification to inform you that the agent associated with this job
                <span style="font-weight: bold">{{ $job->reference }}</span> has signed the timesheet.
            </p>
            <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                <span style="font-weight: bold">Please Sign the timesheet for the below job to proceed</span>.
            </p>
