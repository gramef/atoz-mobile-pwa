...
@section('content')
    <thead>
        <th style="font-size: 28px; font-weight: bold; padding-bottom: 20px;">Request approved</th>
    </thead>
    <tbody>
        <tr>
            <td>
                <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                        Your job request has now been approved. You can now access the <a style="color: #efa847;text-decoration: navajowhite;" href="{{ route('setup-account', $token) }}">A-Z Portal</a> to track your job request.
                </p>
                <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                    Thanks, <br>
                    A-Z Interpreting.
