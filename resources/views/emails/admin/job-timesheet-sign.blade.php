...
@section('content')
    <thead>
        <th style="font-size: 28px; font-weight: bold; padding-bottom: 20px;">
            The Timesheet for the job {{ $job->reference }} is done successful
        </th>
    </thead>
    <tbody>
        <tr>
            <td>
                <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                    This is an email notification to inform you that both the agent and client signed the timesheet for this job
                    <span style="font-weight: bold">{{ $job->reference }}</span> .
                </p>
                <p style="font-size: 16px; font-weight: 500; line-height: 22px; margin-top: 0px; margin-bottom: 27px;">
                    Please login to print the timesheet.
                </p>
