        ...
        <td>
            <table style="padding: 12px 17px 14px; width: 100%">
                ...
                <tr>
                    ...
                    <td style="font-weight: 500">{{ $job['updated']->appointment_date->format('d/m/Y') }}</td>
                ...
                <tr>
                    ...
                    <td style="font-weight: 500">{{ $job['updated']->start_time }} ({{ $job['updated']->formattedDuration }})
                    </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align: center">
    <tr>
        <td>
            <div>
                <!--[if mso]>
                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ route('interpreter-jobs.show', $job['updated']->id) }}" style="height:36px;v-text-anchor:middle;width:150px;" arcsize="5%" strokecolor="#EFA847" fillcolor="#EFA847">
                                <w:anchorlock/>
                                <center style="color:#ffffff;font-weight: 500;font-family:Helvetica, Arial,sans-serif;font-size:16px;">Portal Login</center>
                            </v:roundrect>
                            <![endif]-->
                <a href="{{ route('interpreter-jobs.show', $job['updated']->id) }}"
