                ...
                @forelse ($clients as $client)
                    <tr class="table__row">
                        ...
                        <td class="table__data">
                            ...
                            {{ Form::open([ 'route' => [ 'clients.destroy', $client->id ], 'method' => 'DELETE', 'class' => 'd-inline-block' ]) }}

                                <button class="btn btn--cancel table__btn" type="submit" onclick="return confirm('Are you sure you want to delete this client?')">
                                    Delete
                                </button>

                            {{ Form::close() }}

                            {{ Form::open([ 'route' => [ 'clients.archived.destroy', $client->id ], 'method' => 'DELETE', 'class' => 'd-inline-block' ]) }}

                                <button class="btn btn--grey table__btn" type="submit" onclick="return confirm('Are you sure you want to restore this client?')">
                                    Restore
                                </button>

                            {{ Form::close() }}

                            <a class="btn btn--secondary table__btn" href="{{ route('clients.archived.show', $client->id) }}">View</a>
                        </td>
                    </tr>
                @empty
                    <tr class="table__row">
